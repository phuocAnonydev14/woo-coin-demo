    ...
    <div className="mb-3 flex w-full flex-col gap-5">
      <div className="flex items-center gap-[8px]">
        <div className="flex items-center gap-1">
          <img className="h-6 w-6 rounded-full object-cover" src={icon} alt="User avatar" />
      ...
      <div className="flex flex-col gap-3">
        {!isDetailPage ? (
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-y-1.5 break-words leading-7 tracking-wide">
              {parse(filterHtmlString(html))}
            </div>
          </div>
        )}
      </div>
